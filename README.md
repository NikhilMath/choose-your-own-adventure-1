...
- Static HTML: no site header or footer (the user removed the “OTHER PATHS / STORIES YOU STEP INTO” bar and the “Employee happiness is a company priority. / YOUR CHOICES. YOUR STORY.” footer); the page opens straight into the cover panel and inline SVG keyboard illustration on the left, interactive story on the right; stacked on narrow screens.

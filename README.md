...
- Static HTML: no site header (the user removed the “OTHER PATHS / STORIES YOU STEP INTO” bar); the page opens straight into the cover panel and inline SVG keyboard illustration on the left, interactive story on the right; stacked on narrow screens.
